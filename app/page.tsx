...
import { Users, Clock, AlertCircle, CheckCircle, ChevronRight } from "lucide-react";
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-5 border border-gray-200">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className={`w-full py-3.5 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] ${
                  !name.trim() || isJoining
            ...
            {updates.length > 0 ? (
              <div className="divide-y divide-gray-100 max-h-64 overflow-y-auto">
                {updates.map((u, i) => (
                  <div 
                    key={i} 
                    className={`px-5 py-3.5 flex items-center transition-all duration-200 ${
